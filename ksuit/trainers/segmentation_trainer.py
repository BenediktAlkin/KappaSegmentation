...
from ksuit.distributed import all_gather_grad
...
class SegmentationTrainer(SgdTrainer):
    ...
    class Model(nn.Module):
        ...
        def forward(self, batch, reduction="mean"):
            ...
            # gather because loss is not independent of batch_size
            # preds = {key: all_gather_grad(value) for key, value in preds.items()}
            # target = all_gather_grad(target)
