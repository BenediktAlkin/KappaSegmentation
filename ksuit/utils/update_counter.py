...
class UpdateCounter:
    def __init__(
        ...
        # use update instead of epoch here as epoch is int and therefore wouldnt work with update based ckpts
        assert self.start_checkpoint == Checkpoint(update=self.start_checkpoint.update).to_fully_specified(
